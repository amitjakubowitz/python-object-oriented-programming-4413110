...
print(b1 == b3) #true because __eq__ before that is was False because b1 and b3 are in different places in memory 
print(b1 == b2) 
#print(b1 == 42) #valueerror
...
books = [b1,b3,b2,b4]
books.sort() #uses price because it accesses ge and lt (there are also gt and le)
