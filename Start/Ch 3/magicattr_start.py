...
class Book:
    ...
    def __getattribute__(self, name):  
        if name == "price": #this one is specific for price
    ...
    # TODO: __getattr__ called when __getattribute__ lookup fails (or undefined) - you can
...
b1.price = float(40)
print(b1.randomprop) #no randomprop so __getattr__ will be called